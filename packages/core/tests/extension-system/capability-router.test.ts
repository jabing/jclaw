...
describe('CapabilityRouter', () => {
  ...
  describe('hasCapability', () => {
    it('should return true for registered capability', () => {
      registry.register(
        createMockExtension('ext', [{ name: 'test-cap', description: 'Test' }])
      );
  ...
  describe('getAllCapabilities', () => {
    it('should return all capabilities with their providers', () => {
      registry.register(
        createMockExtension('ext1', [{ name: 'cap1', description: 'Cap 1' }])
      );
      registry.register(
        createMockExtension('ext2', [{ name: 'cap2', description: 'Cap 2' }])
      );
      ...
      expect(
        allCaps.find((c) => c.capability.name === 'cap1')?.extensionName
      ).toBe('ext1');
      expect(
        allCaps.find((c) => c.capability.name === 'cap2')?.extensionName
      ).toBe('ext2');
    });
  });
  ...
  describe('validateInput', () => {
    ...
    it('should return true when no schema defined', () => {
      registry.register(
        createMockExtension('ext', [{ name: 'cap', description: 'No schema' }])
      );
    ...
    it('should validate required fields', () => {
      ...
      expect(router.validateInput('cap', { name: 'test', value: 123 })).toBe(
        true
      );
  ...
  describe('stats', () => {
    it('should return capability statistics', () => {
      ...
      registry.register(
        createMockExtension('ext2', [{ name: 'cap3', description: 'Cap 3' }])
      );
